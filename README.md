...
# Code 2 - Quantum Tomography And Bell Test/Quantum Tomography - Raw Data Extraction.py
...
# Code 3 - Quantum Tomography Thresholds.py
Description - This code is to be used after code 2 has been implemented. It takes the unfiltered pulse intensity graphs and allows the user to manually choose the thresholds for each graph by clicking on the intensity graph at some intensity height. This is done in order to filter noise. 
