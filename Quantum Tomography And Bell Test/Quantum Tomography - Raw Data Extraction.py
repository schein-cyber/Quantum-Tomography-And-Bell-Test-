...
VIDEO_FILES = [
    "Tomography 10 bits.mp4",
    "Tomography 25 bits.mp4",
    "Tomography 50 bits.mp4"
]
...
# ============================================================
# PHASE 2: PROCESS ALL VIDEOS (AUTOMATED)
# ============================================================
...
for video_file in VIDEO_FILES:
    ...
    # Save Results
    file_label = video_file.replace(".mp4", "").replace(" ", "_").lower()
...
print("\nAll Tomography files processed successfully.")